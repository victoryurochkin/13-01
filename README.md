...
FIN	               Нет ответа	                   RST
Xmas	             Нет ответа	                   RST
UDP	               Нет ответа	                   ICMP Unreachable

Во время анализа в Wireshark было видно, что Metasploitable отвечает «классически», без дополнительных механизмов защиты, что делает его удобным объектом для учебных экспериментов.
